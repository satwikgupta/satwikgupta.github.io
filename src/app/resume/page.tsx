  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        >
          <TabsList className="flex flex-col w-full max-w-[380px] mx-auto lg:mx-0 gap-6 text-white">
          ...
          <div className="min-h-[70vh] w-full">
                  ...
                  <ul className="grid grid-cols-1 xl:grid-cols-2 gap-[30px]">
                    {education.items.map((item, index) => {
                      return (
                        ...
                        >
                          <span className="text-accent">{item.duration}</span>
                          <h3 className="text-xl max-w-[260px] tracking-tight min-h-[60px] text-center lg:text-left">
                            {item.degree}
                          </h3>
                          <div className="flex items-center gap-3">
                            <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
            ...
            <TabsContent value="skills" className="w-full h-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 lg:gap-[30px] gap-4">
                        ...
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className="w-full h-[150px] bg-[#232329] rounded-xl flex justify-center items-center group">
                              <div className="text-6xl group-hover:text-accent transition-all durantion-3000">
